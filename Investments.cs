        ...
        private void FillFundsList(List<InvestmentContractBalance> balancesInfo)
        {
            ...
            List<Fund> funds = balancesInfo
                    .SelectMany(
                        b => b.FundsBalance
                            .Select(
                                f => new Fund(f.Identifier, f.Shares, f.PriceSale, f.MarketSale, f.Pecerntage,false)
                            )).ToList();
            ...
            List<Fund> fundsPending = balancesInfo
                    .SelectMany(
                        b => b.CashBalance
                            ...
                            .Select(
                                f => new Fund(f.Identifier, f.Shares, f.PriceSale, f.MarketSale, f.Pecerntage, true)
                            )).ToList();
